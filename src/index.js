import { createMeeClient, toSmartSessionsModule, toMultichainNexusAccount, MEEVersion, getMEEVersion, meeSessionActions, getSudoPolicy } from "@biconomy/abstractjs";
import { privateKeyToAccount } from "viem/accounts";
import { baseSepolia } from "viem/chains";
import { http, getAddress, erc20Abi, parseUnits, toFunctionSelector, getAbiItem } from "viem";
...
export const smartSession = async () => {
    ...
    const sessionSigner = privateKeyToAccount(sinnerSessionKey);
    //
